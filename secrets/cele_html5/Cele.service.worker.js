...
const CACHE_NAME = "Cele-cache";
const OFFLINE_URL = "Cele.offline.html";
// Files that will be cached on load.
const CACHED_FILES = ["Cele.html","Cele.js","Cele.wasm","Cele.pck","Cele.offline.html","Cele.icon.png","Cele.apple-touch-icon.png"];
